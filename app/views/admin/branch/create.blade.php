		  	...
		  	<form action="{{ route('admin_branches.store') }}"  class="form-horizontal tasi-form" method="POST">
		       ...
		       <div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				      {{ Form::select('country', $countries, Input::old('country', $default_country_code), ['class' => 'form-control m-bot15']) }}
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				      {{ Form::select('status', ['1' => 'Active', '0' => 'Inactive'], Input::old('status'), ['class' => 'form-control m-bot15']) }}
				  </div>
				</div>
