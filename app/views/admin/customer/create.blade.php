...
@section('content')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form action="{{ route('admin_customers.store') }}"  class="form-horizontal tasi-form" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="contact_number" class="form-control" value="{{ Input::old('contact_number') }}" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="any" name="total_credits" class="form-control" value="{{ Input::old('total_credits') }}" />
                    </div>
                </div>
